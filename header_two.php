...
<head>
    ...
    <title>Beach Rugby Africa :: Official Website</title>
    ...
    <link rel="stylesheet" type="text/css" href="css/OwlCarousel2-2.3.4/dist/assets/owl.carousel.min.css">

    <link rel="stylesheet" type="text/css" href="css/OwlCarousel2-2.3.4/dist/assets/owl.theme.default.min.css">
...
<body id="top">
    ...
    <header class="s-header">
        ...
        <nav class="header-nav">
            ...
            <img src="images/rugbyAfricawhite.png" alt="Homepage">
...
Lagos Beach Rugby is a 3 a side (rolling subs) touch rugby tournament. Each game is played for 5 mins each way</p>
